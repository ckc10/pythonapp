...
# First line: Buy, Sell
button_buy = tk.Button(root, text="Buy", command=lambda: send_post_request("Buy_CE"),bg="green")
button_buy.grid(row=1, column=1, padx=10, pady=10)

button_sell = tk.Button(root, text="SL", command=lambda: send_post_request("Sell_CE"),bg="red")
button_sell.grid(row=1, column=3, padx=10, pady=10)

##updating for the buttons in second line
button_s1 = tk.Button(root, text="S1", command=lambda: send_post_request("CE_Sell_1"),bg="orange")
button_s1.grid(row=2, column=1, padx=10, pady=10)

button_s2 = tk.Button(root, text="S2", command=lambda: send_post_request("CE_Sell_2"),bg="orange")
button_s2.grid(row=2, column=2, padx=10, pady=10)

button_s3 = tk.Button(root, text="S3", command=lambda: send_post_request("CE_Sell_3"),bg="orange")
...
button_exit = tk.Button(root, text="EXIT", command=lambda: send_post_request("CE_Exit"), bg="blue")
